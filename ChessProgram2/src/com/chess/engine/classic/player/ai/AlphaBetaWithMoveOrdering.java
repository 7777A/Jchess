...
public class AlphaBetaWithMoveOrdering extends Observable implements com.chess.engine.classic.player.ai.MoveStrategy {

    private final com.chess.engine.classic.player.ai.BoardEvaluator evaluator;
    ...
    public AlphaBetaWithMoveOrdering(final int searchDepth,
        ...
        this.evaluator = com.chess.engine.classic.player.ai.StandardBoardEvaluator.get();
