...
public final class Rook extends com.chess.engine.classic.pieces.Piece {
    ...
    public Rook movePiece(final Move move) {
        return com.chess.engine.classic.pieces.PieceUtils.INSTANCE.getMovedRook(move.getMovedPiece().getPieceAllegiance(), move.getDestinationCoordinate());
    }
